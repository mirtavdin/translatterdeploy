...
async def start(client, message):
	await message.reply_text(text =f"Salam **{message.from_user.first_name }** \n\n __Mən 🌐 Google Translate Bot 'Am\n Mən Göndərdiyin Mesajı Seçdiyin Dilə Tərcümə Etmək Üçün Proqramlaşdırılmışam\nBaşlamaq Üçün Mənə 1 Mesaj Göndər__",reply_to_message_id = message.message_id ,parse_mode="markdown", reply_markup=InlineKeyboardMarkup([ [InlineKeyboardButton("⚡ DİGƏR BOTLARIM" ,url="t.me/menimbotlarim") ],               [InlineKeyboardButton("🇦🇿 OWNER 👨‍💻", url="t.me/sesizKOLGE") ]   ]  ) )
